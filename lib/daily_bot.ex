defmodule DailyBot do
  ...
  def start(_, _) do
    ...
    rhost = ExGram.Config.get(:daily_bot, :redis_host, "localhost")
    rport = ExGram.Config.get_integer(:daily_bot, :redis_port, 6379)

    token = ExGram.Config.get(:daily_bot, :token)
